...
<body>
  <div class="topnav">
    <a class="active" href="animals.php"><img src="ic_add_pet.png"></a>
...
border: 3px solid green;background-color: #4CAF50;color:#f2f2f2;font-size:17px;" formaction="animalsupdate.php">update animal</button>
    </form>
  </div>
  <?php
